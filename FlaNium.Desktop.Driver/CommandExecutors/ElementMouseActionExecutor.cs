...
namespace FlaNium.Desktop.Driver.CommandExecutors
{
    ...
    class ElementMouseActionExecutor : CommandExecutorBase
    {
        protected override string DoImpl()
        {
            ...
            switch (action) {
                case "move": Mouse.MoveTo(x, y);
                    break;
                case "click": Mouse.LeftClick(new Point(x, y));
                    break;
                case "rightClick":
                ...
                case "doubleClick":
                    ...
                    break;
                default: return this.JsonResponse(Common.ResponseStatus.UnknownCommand, "Uknown action value: " + action);
            }
